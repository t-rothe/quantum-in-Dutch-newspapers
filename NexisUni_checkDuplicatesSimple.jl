...
function extract_metadata(file, encoding)
    ...
    metadata_dict["Headline"] = file_content_lines[1]
    ...
    """
    metadata_dict["Body"] = join(file_content_lines[5:end-5], " \n ")

    #Correct for missing values:
    metadata_dict["Author Name"] = ""
    metadata_dict["Word Count"] = 0
    metadata_dict["Weekday"] = 0
    metadata_dict["Day"] = 0
    metadata_dict["Month"] = 0
    metadata_dict["Year"] = 0
    metadata_dict["Newspaper Section"] = "Unknown"
    metadata_dict["Newspaper Name"] = "Unknown"
